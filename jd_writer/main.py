...
company_description = "Paytm is a indian leader and revolutioniser of payment gateways. It built and made UPI transactions in india very feasible."
company_domain = "payments"
hiring_needs = "senior Python developer, with 5 years of experience in django"
specific_benefits = "salary, health insuarance, food vouchers, pf account"
...
with open("job_posting.md", "a") as file:
